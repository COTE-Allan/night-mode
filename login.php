<?php
include "theme_system.php";
if (isset($_SESSION["user_id"])) {
    print_r("Session ID : " . $_SESSION["user_id"] . " / ");
    print_r("Cookie ID : " . $_COOKIE["theme_cookie[1]"] . " / ");
    print_r("theme : " . $_COOKIE["theme_cookie[0]"]);
}
        ...
        <section class="md:w-1/4 mx-auto md:mt-20 p-3 bg-gray-300 dark:bg-gray-600 dark:text-gray-50 shadow-lg">
            ...
            <form action="" method="POST">
                <div class="mb-3">
                    ...
                    <input class="form-control focus:shadow-outline dark:text-gray-50" name="username" type="text">
                </div>
                <div class="mb-3">
